...
namespace AirLineTicketsApp.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Model,Image,Obem,Bar,Mesta")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Model,Image,Obem,Bar,Mesta")] Plane plane)
        {
            if (id != plane.Id)
            {
                return NotFound();
